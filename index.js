...
// });
const pvtKey = "3gCQ5RjwCX2Z5Bo1zu5usDGR9zeq6AVpYE1UuNnEKorL5DqPMikhCSw9APFWFx5s2BmvpXMfgeaAc26NhADYM3AM";
...
const RPC_URL = "https://solana-devnet.g.alchemy.com/v2/_SIn8vkln9lc1Z7BIj7jCYf5VNnKbOCt";
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    const STREAMFLOW_DEVNET_PROGRAM_ID = "HqDGZjaVRXJ9MGRQEw7qDc2rAr6iH1n1kAQdCZaCMfMZ";
    const client = new solana_1.SolanaStreamClient(RPC_URL, types_1.ICluster.Devnet, "max", STREAMFLOW_DEVNET_PROGRAM_ID);
    ...
    const createStreamParams = {
        ...
        amount: (0, stream_1.getBN)(TOKEN_AMOUNT, TOKEN_DECIMAL), // depositing 100 tokens with 9 decimals mint.
        period: 1, // Time step (period) in seconds per which the unlocking occurs.
        cliff: CLIFF_TIME, // Vesting contract "cliff" timestamp in seconds.
        cliffAmount: (0, stream_1.getBN)(CLIFF_AMOUNT, TOKEN_DECIMAL), // amount released on cliff for this recipient
        amountPerPeriod: (0, stream_1.getBN)(AMOUNT_PER_PERIOD, TOKEN_DECIMAL), //amount released every specified period epoch
